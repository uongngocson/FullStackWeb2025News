...
// ResponseEntity<List> response = restTemplate.getForEntity(apiUrl,
// List.class);
// List<Map<String, String>> languagesList = response.getBody(); // Cast to
...
// }
// } catch (Exception e) {
// System.err.println("Error fetching or processing supported languages: " +
// e.getMessage());
