...
public class LibreTranslateService {
    ...
    // --- Bỏ các dòng kiểm tra isLanguageSupported ở đây ---
    // if (!isLanguageSupported(sourceLang)) {
    //     System.err.println("Source language " + sourceLang + " is not supported.");
    //     return text;
    // }
    // if (!isLanguageSupported(targetLang)) {
    //     System.err.println("Target language " + targetLang + " is not supported.");
    //     return text;
    // }
    // --- Kết thúc phần bỏ ---
