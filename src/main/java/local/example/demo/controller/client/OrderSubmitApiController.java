...
// */
// @PostMapping("/submit")
// public ResponseEntity<Map<String, Object>> submitOrder(@RequestBody
// SummaryOrderDTO orderDTO) {
// try {
...
// orderDTO.getShippingAddress().getDistrictName());
// System.out.println("Ward Code: " +
// orderDTO.getShippingAddress().getWardCode());
// System.out.println("Ward Name: " +
// orderDTO.getShippingAddress().getWardName());
// }
...
// orderDTO.getOrderCalculation().getTaxAmount());
...
// orderDTO.getOrderCalculation().getAppliedDiscounts());
// }
// }
...
// orderDTO.getClass().getMethod("getOrderItems");
// if (method != null) {
...
// System.out.println("Could not access orderItems through getter: " +
// e.getMessage());
...
// // Calculate and validate all amounts using SummaryService's calculation
// method
...
// throw new RuntimeException("Order processing failed - null response from
// service");
// }
...
// calculationDetails.put("subtotal",
// orderDTO.getOrderCalculation().getSubtotal());
// calculationDetails.put("totalDiscount",
// orderDTO.getOrderCalculation().getTotalDiscountAmount());
// calculationDetails.put("taxAmount",
// orderDTO.getOrderCalculation().getTaxAmount());
// calculationDetails.put("finalTotal",
// orderDTO.getOrderCalculation().getFinalTotal());
...
// } else {
// // Error from stored procedure - map specific error codes to HTTP status
// codes
...
// mapErrorCodeToHttpStatus(orderResponse.getErrorCode());

// // Log the error for server-side tracking
// System.out.println("Order processing failed with error code: " +
...
// if (orderDTO.getShippingAddress() == null) {
// fieldErrors.put("shippingAddress",
// ErrorCodes.getErrorMessage(ErrorCodes.MISSING_REQUIRED_FIELD));
// } else {
...
// if (orderDTO.getPayment() == null || orderDTO.getPayment().getMethod() ==
// null ||
// orderDTO.getPayment().getMethod().trim().isEmpty()) {
// fieldErrors.put("payment.method",
// ErrorCodes.getErrorMessage(ErrorCodes.MISSING_REQUIRED_FIELD));
// }
...
// // Chấp nhận bất kỳ số điện thoại nào chỉ chứa chữ số, dấu +, dấu ngoặc đơn,
// dấu gạch ngang, dấu chấm hoặc khoảng trắng
