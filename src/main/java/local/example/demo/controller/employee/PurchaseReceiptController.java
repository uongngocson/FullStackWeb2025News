...
@Controller("employeePurchaseReceiptController")
@RequestMapping("/employee/receipt-mgr")
...
public class PurchaseReceiptController {
    ...
    public String getAllReceipts(Model model) {
        try {
            ...
            return "employee/receipt-mgr/receipt-list";
        } catch (Exception e) {
    ...
    public String showReceiptDetail(@PathVariable Integer receiptId, Model model,
        ...
        try {
            ...
            if (!receiptOpt.isPresent()) {
                ...
                return "redirect:/employee/receipt-mgr/list";
            }
            ...
            return "employee/receipt-mgr/detail-receipt"; // Cần tạo file JSP này
        } catch (Exception e) {
    ...
    public String showUpdateForm(@PathVariable Integer receiptId, Model model, RedirectAttributes redirectAttributes) {
        try {
            ...
            return "employee/receipt-mgr/update-receipt"; // Sử dụng file JSP đã cung cấp
        } catch (Exception e) {
    ...
    public String saveReceipt(
        ...
        try {
            ...
            if (purchaseReceipt.getId() == null && purchaseReceipt.getReceiptCode() != null
                ...
                return "redirect:/employee/receipt-mgr/create";
            }
            ...
            if (totalAmount != null) {
                ...
                return purchaseReceipt.getId() == null ? "redirect:/employee/receipt-mgr/create"
                        : "redirect:/employee/receipt-mgr/update/" + purchaseReceipt.getId();
            }
