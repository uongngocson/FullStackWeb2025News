const dataUrl = '../../../../resources/assets/user/db/shopee.json'

// ../../../../resources/assets/user/js/product.js
...
function renderItem(items) {
    ...
    var htmls = items.map(function (item) {
        ...
        <div data="${item.id}" class="col l-2-4 m-3 c-6 home-product-item">
            <a class="home-product-item-link" href="/detailmenu">
                <div class="home-product-item__img" style="background-image: url(../../../../resources/assets/user/img/home/${item.id}.PNG);"></div>
