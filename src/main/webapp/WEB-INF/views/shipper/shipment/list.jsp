                                                                ...
                                                                <td>
                                                                    <c:choose>
                                                                        <c:when test="${shipment.paymentMethod == 'COD'}">
                                                                            ...
                                                                            <!-- Show COD payment status if available -->
                                                                            <c:if test="${shipment.status == 'COMPLETED'}">
                                                                                <br><small class="text-muted">COD Status: 
                                                                                    <c:set var="codPayment" value="${codPaymentMap[shipment.shipmentId]}" />
                                                                                    <c:choose>
                                                                                        <c:when test="${codPayment != null}">
                                                                                            <c:choose>
                                                                                                <c:when test="${codPayment.submittedStatus == 'NOT_SUBMITTED'}">
                                                                                                    <span class="badge badge-warning badge-sm">CHƯA NỘP</span>
                                                                                                </c:when>
                                                                                                <c:when test="${codPayment.submittedStatus == 'SUBMITTED_CASH'}">
                                                                                                    <span class="badge badge-success badge-sm">ĐÃ NỘP (TIỀN MẶT)</span>
                                                                                                </c:when>
                                                                                                <c:when test="${codPayment.submittedStatus == 'SUBMITTED_MOMO'}">
                                                                                                    <span class="badge badge-success badge-sm">ĐÃ NỘP (MOMO)</span>
                                                                                                </c:when>
                                                                                                <c:when test="${codPayment.submittedStatus == 'SUBMITTED_VNPAY'}">
                                                                                                    <span class="badge badge-success badge-sm">ĐÃ NỘP (VNPAY)</span>
                                                                                                </c:when>
                                                                                                <c:otherwise>
                                                                                                    <span class="badge badge-secondary badge-sm">${codPayment.submittedStatus}</span>
                                                                                                </c:otherwise>
                                                                                            </c:choose>
                                                                                        </c:when>
                                                                                        <c:otherwise>
                                                                        ...
                                                                        <c:when test="${shipment.paymentMethod == 'PREORDER'}">
                                                                            <span class="badge badge-primary">PREORDER</span>
                                                                        </c:when>
                                                                        <c:when test="${shipment.paymentMethod == 'ONLINE'}">
                                                                            <span class="badge badge-primary">ONLINE</span>
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                            <span class="badge badge-secondary">${shipment.paymentMethod}</span>
                                                                        </c:otherwise>
                                                                    </c:choose>
                                                                </td>
