                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <a href="${post.permalinkUrl}" target="_blank" class="mt-2 block">
                                                        <p class="text-xl font-semibold text-gray-900">
                                                            <c:out
                                                                value="${not empty post.message ? (post.message.length() > 50 ? post.message.substring(0, 50).concat('...') : post.message) : 'Bài viết không có nội dung chữ'}" />
                                                        </p>
                                                        <p class="mt-3 text-base text-gray-500">
                                                            <fmt:parseDate value="${post.createdTime}"
                                                                pattern="yyyy-MM-dd'T'HH:mm:ssZ" var="parsedDate" />
                                                            Đăng ngày:
                                                ...
                                                <div class="mt-6 flex items-center">
                                                    ...
                                                    <div class="ml-3">
                                                        <p class="text-sm font-medium text-gray-900">
                                                            <a href="https://facebook.com/${post.id.split('_')[0]}"
