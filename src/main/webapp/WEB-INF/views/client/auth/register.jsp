                            ...
                            <div class="form-two--item2">
                                <div class="form-two--item2--list1">
                                    <form:form action="${pageContext.request.contextPath}/register"
                                        ...
                                        <!-- phone number -->
                                        <div class="form-two-icon2">
                                            <form:input placeholder="Số điện thoại" class="form-two-icon2"
                                                path="phoneNumber" />
                                        ...
                                        <!-- login name -->
                                        <div class="form-two-icon2">
                                            <form:input placeholder="Tên đăng nhập" class="form-two-icon2"
                                                path="loginName" />
                                        ...
                                        <div class="form-two-icon4">
                                            <form:input placeholder="Nhập lại mật khẩu" class="form-two-icon2"
