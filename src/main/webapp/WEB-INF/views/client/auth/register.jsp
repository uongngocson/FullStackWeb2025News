                        ...
                        <div class="w-full md:w-1/2 flex items-center justify-center bg-white overflow-y-auto">
                            <div class="w-full max-w-md p-4 md:p-8">
                                <div class="text-center mb-6">
                                    ...
                                    <p class="text-xs text-gray-500 tracking-wider">JOIN OUR EXCLUSIVE FASHION COMMUNITY
                                    </p>
                                </div>

                                <form:form action="${pageContext.request.contextPath}/register" class="space-y-4"
                                    method="post" modelAttribute="registerDTO">
                                    ...
                                    <div>
                                        ...
                                        <c:if test="${not empty errors.firstName}">
                                            <div class="text-red-600 bg-red-100 p-2 rounded mt-2 text-sm">
                                    ...
                                    <!-- phone number -->
                                    <div>
                                        <label for="phoneNumber" class="block text-xs uppercase tracking-wider mb-2">Số
                                            điện
                                            thoại</label>
                                    ...
                                    <!-- login name -->
                                    <div>
                                        <label for="loginName" class="block text-xs uppercase tracking-wider mb-2">Tên
                                            đăng
                                            nhập</label>
                                    ...
                                    <div>
                                        <label for="confirmPassword"
                                            class="block text-xs uppercase tracking-wider mb-2">Nhập lại mật
                                            khẩu</label>
