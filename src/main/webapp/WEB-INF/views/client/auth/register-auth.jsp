                ...
                <div class="form-two">
                    <div class="form-two--item2">
                        <div class="form-two--item2--list1">
                            <form action="/client/auth/register-auth" method="post" class="form-two--item2--list1-con">
                                <div class="form-two-icon1">
                                    <div>Xác nhận đăng ký</div>
                                </div>
                                <div class="form-two-icon2">
                                    <input placeholder="Nhập mã xác nhận" class="form-two-icon2" name="verificationCode"/>
                                </div>
                                <c:if test="${not empty verificationError}">
                                    <div class="text-danger">${verificationError}</div>
                                </c:if>
                                ...
                                <div class="form-two-icon4">
                                    ...
                                    <a href="/client/auth/resend-verification" class="form-two-icon4-icon1">Gửi lại mã xác nhận</a>
                                </div>
                            </form>
