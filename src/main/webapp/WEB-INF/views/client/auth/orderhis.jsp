                                    ...
                                    <div class="mx-auto max-w-5xl">
                                        ...
                                        <div class="mt-6 flow-root sm:mt-8">
                                            <div class="divide-y divide-gray-200 dark:divide-gray-700">
                                                <!-- Tiêu đề cột -->
                                                <div
                                                    class="flex flex-wrap items-center gap-y-4 py-6 font-semibold text-gray-900 dark:text-white">
                                                            ...
                                                            <div class="flex flex-wrap items-center gap-y-4 py-6">
                                                                    ...
                                                                    <dd
                                                                        ...
                                                                        <c:catch var="exception">
                                                                            <c:if test="${not empty order.orderId}">
                                                                                <a href="${pageContext.request.contextPath}/management/order/details/${order.orderId}"
                                                                                ...
                                                                                <c:choose>
                                                                                    <c:when
                                                                                        ...
                                                                                        <c:set var="statusClass"
                                                                                            value="bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300" />
                                                                                    ...
                                                                                    <c:when
                                                                                        test="${order.orderStatus == 'Đang xử lý'}">
                                                                                        <c:set var="statusClass"
                                                                                            value="bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300" />
                                                                                        <svg class="me-1 h-3 w-3"
                                                                                            aria-hidden="true"
                                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                                            width="24" height="24"
                                                                                    ...
                                                                                    <c:when
                                                                                        test="${order.orderStatus == 'Đã giao'}">
                                                                                        <c:set var="statusClass"
                                                                                    ...
                                                                                    <c:when
                                                                                        test="${order.orderStatus == 'Cancel'}">
                                                                                        <c:set var="statusClass"
                                                                                            value="bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300" />
                                                                                        <svg class="me-1 h-3 w-3"
                                                                                            aria-hidden="true"
                                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                                            width="24" height="24"
                                                                                    ...
                                                                                    <c:otherwise>
                                                                                        <c:set var="statusClass"
                                                                                            value="bg-gray-100 text-gray-800 dark:bg-gray-900 dark:text-gray-300" />
                                                                                        <svg class="me-1 h-3 w-3"
                                                                                            aria-hidden="true"
                                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                                            width="24" height="24"
                                                                ...
                                                                <!-- <dl class="w-1/2 sm:w-1/6 lg:w-auto lg:flex-1">
                                                                    ...
                                                                    <dd
                                                                        ...
                                                                        <c:catch var="exception">
                                                                            <c:if
                                                                                test="${not empty order.paymentStatus}">
                                                                                <c:out
                                                                                    value="${order.paymentStatus == 1 ? 'Đã thanh toán' : 'Chưa thanh toán'}" />
                                                                            </c:if>
