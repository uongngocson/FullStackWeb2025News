                                    ...
                                    <div class="mx-auto max-w-5xl">
                                        <div class="gap-4 sm:flex sm:items-center sm:justify-between">
                                            ...
                                            <a href="${pageContext.request.contextPath}/review/all"
                                                class="mt-3 inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-lg hover:from-purple-700 hover:to-indigo-700 transition-all duration-300 shadow-md hover:shadow-lg">
                                        ...
                                        <div class="mt-6 flow-root sm:mt-8">
                                            <div class="divide-y divide-gray-200">
                                                <!-- Table Header -->
                                                <div
                                                    class="flex flex-wrap items-center gap-y-4 py-6 font-semibold text-black">
                                                    ...
                                                    <c:otherwise>
                                                        <c:forEach var="order" items="${orders}">
                                                            <div class="flex flex-wrap items-center gap-y-4 py-6">
                                                                <dl class="w-1/2 sm:w-1/6 lg:w-auto lg:flex-1">
                                                                    <dt
                                                                        class="text-base font-medium text-gray-500 sr-only">
                                                                        Mã đơn hàng:</dt>
                                                                    <dd
                                                                        class="mt-1.5 text-base font-semibold text-black">
                                                                        <c:catch var="exception">
                                                                            <c:if test="${not empty order.orderId}">
                                                                                <a href="${pageContext.request.contextPath}/management/order/details/${order.orderId}?page=${currentPage}"
                                                                                    class="text-blue-500 hover:underline">#${order.orderId}</a>
                                                                            </c:if>
                                                                        ...
                                                                        <c:if test="${not empty exception}">
                                                                            <p class="text-red-500">Lỗi (Mã đơn hàng):
                                                                                ${exception.message}</p>
                                                                        </c:if>
                                                                    </dd>
                                                                </dl>
                                                                ...
                                                                <dl class="w-1/2 sm:w-1/6 lg:w-auto lg:flex-1">
                                                                    ...
                                                                    <dd
                                                                        ...
                                                                        <c:if test="${not empty exception}">
                                                                            <p class="text-red-500">Lỗi (Ngày đặt):
                                                                                ${exception.message}</p>
                                                                        </c:if>
                                                                    </dd>
                                                                </dl>
                                                                ...
                                                                <dl class="w-1/2 sm:w-1/6 lg:w-auto lg:flex-1">
                                                                    ...
                                                                    <dd
                                                                        ...
                                                                        <c:if test="${not empty exception}">
                                                                            <p class="text-red-500">Lỗi (Tổng tiền):
                                                                                ${exception.message}</p>
                                                                        </c:if>
                                                                    </dd>
                                                                </dl>
                                                                    ...
                                                                    <dd
                                                                        ...
                                                                        <c:catch var="exception">
                                                                            <c:if test="${not empty order.orderStatus}">
                                                                                <c:choose>
                                                                                    <c:when
                                                                                        test="${order.orderStatus == 'PENDING'}">
                                                                                    ...
                                                                                    <c:when
                                                                                        test="${order.orderStatus == 'CONFIRMED'}">
                                                                                        <c:set var="statusClass"
                                                                                ...
                                                                                <span
                                                                                    class="${statusClass}">${order.orderStatus}</span>
                                                                            </c:if>
                                                                        ...
                                                                        <c:if test="${not empty exception}">
                                                                            <p class="text-red-500">Lỗi (Trạng thái):
                                                                                ${exception.message}</p>
                                                                        </c:if>
                                                                    </dd>
                                                                </dl>
                                                                    ...
                                                                    <c:catch var="exception">
                                                                        <c:if test="${not empty order.orderStatus}">
                                                                            <c:if
                                                                                test="${order.orderStatus == 'PENDING'}">
                                                                                <form
                                                                                    action="${pageContext.request.contextPath}/management/order/cancel/${order.orderId}?page=${currentPage}"
                                                                                    method="post"
                                                                                    onsubmit="confirmCancel(event)">
                                                                                    <sec:csrfInput />
                                                                                    <button type="submit"
                                                                                        class="w-full rounded-lg border border-red-700 px-3 py-2 text-center text-sm font-medium text-red-700 hover:bg-red-700 hover:text-white focus:outline-none focus:ring-4 focus:ring-red-300 lg:w-auto">Hủy
                                                                                        đơn hàng</button>
                                                                                </form>
                                                                            </c:if>
                                                                        </c:if>
                                                                        <c:if test="${not empty order.orderId}">
                                                                            <a href="${pageContext.request.contextPath}/management/order/details/${order.orderId}?page=${currentPage}"
                                                                                class="w-full inline-flex justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 lg:w-auto">Xem
                                                                                chi tiết</a>
                                                                        </c:if>
                                                                    </c:catch>
                                                                    <c:if test="${not empty exception}">
                                                                        <p class="text-red-500">Lỗi (Hành động):
                                                                            ${exception.message}</p>
                                                                    </c:if>
                                                                </div>
                                                            </div>
                                        ...
                                        <c:if test="${totalPages > 1}">
                                            <nav class="mt-6 flex items-center justify-center sm:mt-8"
                                                ...
                                                <ul class="flex h-8 items-center -space-x-px text-sm">
                                                    ...
                                                    <li>
                                                        <c:choose>
                                                            <c:when test="${currentPage > 0}">
                                                                <a href="${pageContext.request.contextPath}/management/historyorder?page=${currentPage - 1}"
                                                    ...
                                                    <c:set var="endPage"
                                                        value="${currentPage + 2 > totalPages - 1 ? totalPages - 1 : currentPage + 2}" />
                                                    <c:if test="${startPage > 0}">
                                                        <li>
                                                            <a href="${pageContext.request.contextPath}/management/historyorder?page=0"
                                                        ...
                                                        <c:if test="${startPage > 1}">
                                                            <li>
                                                                <span
                                                                    class="flex h-8 items-center justify-center border border-gray-300 bg-white px-3 leading-tight text-gray-500">...</span>
                                                            </li>
                                                        </c:if>
                                                    </c:if>
                                                        ...
                                                        <li>
                                                            <c:choose>
                                                                <c:when test="${i == currentPage}">
                                                                    <span
                                                                        class="z-10 flex h-8 items-center justify-center border border-blue-300 bg-blue-50 px-3 leading-tight text-blue-600">${i
                                                                        + 1}</span>
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <a href="${pageContext.request.contextPath}/management/historyorder?page=${i}"
                                                                        class="flex h-8 items-center justify-center border border-gray-300 bg-white px-3 leading-tight text-gray-500 hover:bg-gray-100 hover:text-gray-700">${i
                                                                        + 1}</a>
                                                                </c:otherwise>
                                                            </c:choose>
                                                        </li>
                                                    ...
                                                    <c:if test="${endPage < totalPages - 1}">
                                                        ...
                                                        <li>
                                                            <a href="${pageContext.request.contextPath}/management/historyorder?page=${totalPages - 1}"
                                                                class="flex h-8 items-center justify-center border border-gray-300 bg-white px-3 leading-tight text-gray-500 hover:bg-gray-100 hover:text-gray-700">${totalPages}</a>
                                                        </li>
                                                    </c:if>
