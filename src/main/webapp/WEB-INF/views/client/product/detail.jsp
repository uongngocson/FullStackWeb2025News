                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pt-[64px] ">
                    <div class="product-container flex flex-col md:flex-row gap-8">
                        ...
                        <div class="w-full md:w-1/2">
                            ...
                            <!-- Color Selection -->
                            <div class="mb-6">
                                <h3 class="text-sm font-medium mb-3">COLOR: <p id="selectedColor" style="display:none;"></p></h3>
                            ...
                            <!-- Size Selection -->
                            <div class="mb-6">
                                <h3 class="text-sm font-medium mb-3">SIZE:<p id="selectedSize" style="display:none;"></p></h3>
                            ...
                            <div class="flex flex-col sm:flex-row gap-3 mb-8">
                                <!-- Nút ADD TO CART -->
                                <button class="btn-primary flex-1 bg-black text-white py-3 font-medium hover:bg-gray-800">
                                    <a href="/user/cart"><i class="fas fa-shopping-cart mr-2"></i> ADD TO CART</a>
                                </button>
                                ...
                                <form action="/user/order" method="get" id="buyNowForm" class="flex-1">
                                    ...
                                    <button type="submit" class="btn-secondary w-full bg-red-600 text-white py-3 font-medium hover:bg-red-700">
