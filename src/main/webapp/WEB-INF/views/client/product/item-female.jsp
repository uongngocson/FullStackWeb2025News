                ...
                <section class="py-6 border-b border-gray-100">
                    <div class="max-w-7xl mx-auto px-6">
                        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                            <div class="text-sm">Showing ${(page.number * page.size) + 1}-${(page.number * page.size) +
                                page.numberOfElements} of ${page.totalElements} products</div>
                                    ...
                                    <div class="relative overflow-hidden mb-4 h-96">
                                        ...
                                        <div
                                            ...
                                            <a href="${ctx}/product/detail/${product.productId}"
                                                class="bg-white px-6 py-2 text-sm tracking-wider border border-black hover:text-white hover:bg-black transition duration-300">
                                                QUICK VIEW
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <c:if test="${totalPages > 1}"> <%-- Only show pagination if there's more than one page --%>
                                    <nav aria-label="Page navigation">
                                        <ul class="flex items-center gap-1">
                                            <%-- Previous Button --%>
                                                <li>
                                                    <a href="${ctx}/product/item-female?page=${currentPage - 1}"
                                                ...
                                                <%-- Page Numbers --%>
                                                    <c:forEach begin="1" end="${totalPages}" var="pageNumber">
                                                        <li>
                                                            <a href="${ctx}/product/item-female?page=${pageNumber}"
