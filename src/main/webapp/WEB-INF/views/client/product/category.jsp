                                                            ...
                                                            <%-- Thêm Fashion Dropdown --%>
                                                                ...
                                                                <div class="dropdown relative">
                                                                    <button
                                                                        ...
                                                                        Fashion <i
                                                                            class="fa-solid fa-chevron-down text-xs"></i>
                                                                        <%-- Thay thế bằng spring:message nếu có --%>
                                                                    </button>
                                                                    <div
                                                                        class="dropdown-menu absolute hidden mt-1 w-48 bg-white border border-gray-200 shadow-lg z-10">
                                                                        <c:url var="allFashionUrl"
                                                                            value="${baseFashionUrl}" /> <%-- URL không
                                                                            có type --%>
                                                                            <a href="${allFashionUrl}"
                                                                                class="block px-4 py-2 text-sm hover:bg-gray-50 ${selectedType == null ? 'font-bold' : ''}">
                                                                                <spring:message
                                                                                    code="category.dropdown.all" />
                                                                            </a>
                                                                            <c:url var="menUrl"
                                                                                value="${baseFashionUrl}">
                                                                                <c:param name="type" value="true" />
                                                                                <%-- type=1 (true) for Men --%>
                                                                            </c:url>
                                                                            <a href="${menUrl}"
                                                                                class="block px-4 py-2 text-sm hover:bg-gray-50 ${selectedType == true ? 'font-bold' : ''}">
                                                                                Men <%-- Thay thế bằng spring:message
                                                                                    nếu có --%>
                                                                            </a>
                                                                            <c:url var="womenUrl"
                                                                                value="${baseFashionUrl}">
                                                                                <c:param name="type" value="false" />
                                                                                <%-- type=0 (false) for Women --%>
                                                                            </c:url>
                                                                            <a href="${womenUrl}"
                                                                                class="block px-4 py-2 text-sm hover:bg-gray-50 ${selectedType == false ? 'font-bold' : ''}">
                                                                                Women <%-- Thay thế bằng spring:message
                                                                                    nếu có --%>
                                                                            </a>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <%-- Price Range Dropdown --%>
                                                                    <c:url var="basePriceUrl" value="/product/category">
                                                                        <c:if test="${not empty selectedBrandId}">
                                                                            <c:param name="brandId"
                                                                                value="${selectedBrandId}" />
                                                                        </c:if>
                                                                        ...
                                                                        <c:if test="${selectedType != null}"> <%-- Thêm
                                                                                điều kiện cho type --%>
                                                                                <c:param name="type"
                                                                                    value="${selectedType}" />
                                                                        </c:if>
                                                                    ...
                                                                    <%-- Sort Dropdown --%>
                                                                        <c:url var="baseSortUrl"
                                                                            ...
                                                                            <%-- Không cần page=1 ở đây vì sắp xếp không
                                                                                nên reset trang --%>
