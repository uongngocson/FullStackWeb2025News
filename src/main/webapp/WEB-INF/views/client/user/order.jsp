    ...
    <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
            ...
            <body class="min-h-screen">
                ...
                <div class="grid checkout-grid gap-12 md:grid-cols-2">
                    ...
                    <div class="space-y-8 p-[40px]">
                        ...
                        <section>
                            ...
                            <div class="w-full p-4 pl-0 border rounded-md bg-gray-50">
                            ...
                            <!-- Original GHN Shipping Form (initially hidden) -->
                            <div id="shipping-form" class="space-y-4 mt-6" style="display: none;">
                                ...
                                <button type="button" id="calculateShippingBtn"
                                    class="bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded mt-2 mb-2">
                                    Tính phí vận chuyển
                                </button>

                                <button type="button" id="saveAddressBtn"
                                    class="bg-green-500 hover:bg-green-600 text-white font-medium py-2 px-4 rounded mt-2 mb-2 ml-2">
                                    Lưu địa chỉ
                                </button>
                                    ...
                                    confirmAddressBtn.addEventListener('click', function () {
                                        ...
                                        if (selectedAddressElement) {
                                            ...
                                            if (selectedAddress) {
                                                ...
                                                console.log('Updated default address:', selectedAddress);
                        ...
                        <section class="mt-8">
                            <button id="test-order-data"
                                ...
                                Kiểm tra dữ liệu đơn hàng (Test)
                            </button>
                        </section>
                    </div>
                                ...
                                document.addEventListener('DOMContentLoaded', function () {
                                    ...
                                    if (removePromoBtn) {
                                        ...
                                        removePromoBtn.addEventListener('click', function () {
                                            ...
                                            // Reset total back to original value
                ...
                <!-- Hidden input to store address data -->
                <c:if test="${customerAddressesv2 != null}">
                    <input type="hidden" id="customerAddressesData" value='<c:out value="${customerAddressesv2}"/>' />
                </c:if>
                ...
                <script>
                    ...
                    document.addEventListener('DOMContentLoaded', function () {
                        ...
                        console.log('Addresses from JSP model:', '${customerAddressesv2}');
                ...
                <script>
                    ...
                    document.addEventListener('DOMContentLoaded', function () {
                        ...
                        function updateOrderData() {
                            ...
                            // Log updated state
                            console.log('Updated order data:', JSON.parse(JSON.stringify(orderState)));
                        }
                        ...
                        function testOrderData() {
                            ...
                            // Also show a summary in an alert for quick reference
                            const summaryText =
                                `🧾 ĐƠN HÀNG TEST\n\n` +
                                `👤 Khách hàng: ${orderState.customer.fullName || 'Chưa có'}\n` +
                                `📱 SĐT: ${orderState.customer.phone || 'Chưa có'}\n` +
                                `📧 Email: ${orderState.customer.email || 'Chưa có'}\n\n` +
                                `📦 Người nhận: ${orderState.shippingAddress.name || 'Chưa có'}\n` +
                                `📱 SĐT người nhận: ${orderState.shippingAddress.phone || 'Chưa có'}\n` +
                                `🏠 Địa chỉ: ${orderState.shippingAddress.fullAddress || 'Chưa có'}\n\n` +
                                `💳 Phương thức thanh toán: ${orderState.paymentMethod || 'Chưa chọn'}\n` +
                                `🚚 Phí ship: ${orderState.shipping.fee ? orderState.shipping.fee.toLocaleString() + ' VND' : 'Chưa tính'}\n\n` +
                                `Xem chi tiết đầy đủ trong Console (F12)`;
                ...
                <!-- Thêm nút gửi đơn hàng -->
                <div
                    style="margin: 20px; text-align: center; padding: 10px; background-color: #f8f9fa; border-radius: 5px;">
                    <h3>Gửi đơn hàng về Java (Không dùng API)</h3>
                    <p>Nhấn nút bên dưới để gửi dữ liệu đã điền về backend</p>
                    <button id="submitDataButton"
                ...
                <script>
                    ...
                    function calculateCartTotals() {
                        ...
                        const taxElement = document.querySelector('.space-y-3.mb-6 > div:nth-child(3) > span:last-child');
                        const totalElement = document.querySelector('.space-y-3.mb-6 > div:nth-child(4) > span:last-child');
