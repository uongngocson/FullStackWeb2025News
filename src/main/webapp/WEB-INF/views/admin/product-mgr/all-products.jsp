                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex justify-content-between mb-3">
                                                    <div>
                                                        Showing ${products.size()} of ${totalItems} products
                                                    </div>
                                                    <div>
                                                        <form id="pageSizeForm" class="d-flex align-items-center" method="get" action="${ctx}/admin/product-mgr/list">
                                                    ...
                                                    <nav aria-label="Product pagination">
                                                        <ul class="pagination justify-content-center mt-4">
                                                            ...
                                                            <li class="page-item ${currentPage == 0 ? 'disabled' : ''}">
                                                                <a class="page-link" href="${ctx}/admin/product-mgr/list?page=0&size=${pageSize}" aria-label="First">
                                                                    <span aria-hidden="true">&laquo;&laquo;</span>
                                                                </a>
                                                            </li>
                                                            <li class="page-item ${currentPage == 0 ? 'disabled' : ''}">
                                                                <a class="page-link" href="${ctx}/admin/product-mgr/list?page=${currentPage - 1}&size=${pageSize}" aria-label="Previous">
                                                            ...
                                                            <c:forEach begin="${Math.max(0, currentPage - 2)}" end="${Math.min(totalPages - 1, currentPage + 2)}" var="i">
                                                                <li class="page-item ${currentPage == i ? 'active' : ''}">
                                                                    <a class="page-link" href="${ctx}/admin/product-mgr/list?page=${i}&size=${pageSize}">${i + 1}</a>
                                                                </li>
                                                            </c:forEach>
                                                            
                                                            <!-- Next button -->
                                                            <li class="page-item ${currentPage == totalPages - 1 ? 'disabled' : ''}">
                                                                <a class="page-link" href="${ctx}/admin/product-mgr/list?page=${currentPage + 1}&size=${pageSize}" aria-label="Next">
                                                                    <span aria-hidden="true">&raquo;</span>
                                                                </a>
                                                            </li>
                                                            <li class="page-item ${currentPage == totalPages - 1 ? 'disabled' : ''}">
                                                                <a class="page-link" href="${ctx}/admin/product-mgr/list?page=${totalPages - 1}&size=${pageSize}" aria-label="Last">
