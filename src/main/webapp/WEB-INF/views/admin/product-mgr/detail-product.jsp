                                                ...
                                                <div class="col-12">
                                                    <div class="product-variants-container">
                                                        <div
                                                            ...
                                                            <a href="${ctx}/admin/product-variant-mgr/add/${product.productId}"
                                                                                ...
                                                                                <c:when
                                                                                    ...
                                                                                    <c:forEach var="variant"
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <a href="${ctx}/admin/product-variant-mgr/edit/${variant.productVariantId}"
                                                ...
                                                <div class="col-12">
                                                    <div class="product-images-container">
                                                        <div
                                                            ...
                                                            <a href="${ctx}/admin/product-image-mgr/add/${product.productId}"
                                                                class="btn btn-primary btn-sm">
                                                                                ...
                                                                                <c:forEach var="image"
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <%-- Optional: Add Set as
                                                                                            ...
                                                                                            <c:if
                                                                                                test="${!image.priority}">
                                                                                                <a href="${ctx}/admin/product-image-mgr/set-default/${image.productImageId}/${product.productId}"
        ...
        <script>
            function confirmDeleteVariant(variantId, productId) {
                swal({
                    ...
                    if (willDelete) {
                        window.location.href = "${ctx}/admin/product-variant-mgr/delete/" + variantId;
                    }
                });
            }
            ...
            function confirmDeleteImage(imageId, productId) {
                swal({
                    ...
                    if (willDelete) {
                        ...
                        window.location.href = "${ctx}/admin/product-image-mgr/delete/" + imageId + "/" + productId;
                    }
                });
            }
        </script>