                            ...
                            <div class="page-inner">
                                <div class="page-header">
                                    ...
                                    <ul class="breadcrumbs mb-3">
                                        ...
                                        <li class="nav-item"><a href="/admin/product/">Products</a></li>
                                        <li class="separator"><i class="icon-arrow-right"></i></li>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <form:form modelAttribute="product"
                                                action="/product-mgr/update/${product.productId}" method="POST">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <form:select class="form-select" id="shopId"
                                                                    path="shop.shopId">
                                                                    <form:option value="">Select a shop</form:option>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <form:select class="form-select" id="categoryId"
                                                                    ...
                                                                    <form:option value="">Select a category
                                                                    </form:option>
