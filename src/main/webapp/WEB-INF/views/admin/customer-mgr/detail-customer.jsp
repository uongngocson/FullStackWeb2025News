                                                ...
                                                <div class="card-body text-center">
                                                    <div class="profile-img-container">
                                                        ...
                                                        : (ctx.concat(customer.gender ? '/resources/images-upload/customer/avatar-default-male.jpg' : '/resources/images-upload/customer/avatar-default-female.jpg'))}"
                                                            alt="Customer Avatar" class="w-32 h-32 rounded-full object-cover border-4 border-white shadow-lg" style="width: 128px; height: 128px;">
                                                        <div
                                                                                ...
                                                                                <div class="card h-100 border">
                                                                                    <div class="card-body">
                                                                                        <p class="card-text mb-1">
                                                                                            ${address.street},
                                                                                            ${address.ghnWard.wardName}</p>
                                                                                        <p class="card-text mb-1">
                                                                                            ${address.ghnDistrict.districtName},
                                                                                            ${address.ghnProvince.provinceName}</p>
                                                                                        <p class="card-text mb-1">
                                                                                            ${address.country}</p>
                                                                                    </div>
                                                                                </div>
