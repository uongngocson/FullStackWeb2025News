                        ...
                        <div class="page-inner">
                            ...
                            <div
                                ...
                                <div class="ms-md-auto py-2 py-md-0">
                                    <a href="/customer-mgr/create" class="btn btn-primary btn-round">
                                                    ...
                                                    <tbody>
                                                        <c:forEach var="customer" items="${customers}">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="btn-group">
                                                                        <a href="/customer-mgr/${customer.customerId}"
                                                                            class="btn btn-sm btn-info">
                                                                            <i class="fas fa-eye"></i>
                                                                        </a>
                                                                        <a href="/customer-mgr/update/${customer.customerId}"
                ...
                function deleteCustomer(customerId) {
                    swal({
                        ...
                        if (willDelete) {
                            ...
                            $.ajax({
                                url: '/customer-mgr/delete/' + customerId,
                                type: 'POST',
                                success: function (response) {
                                    swal("${message}!", "The customer has been deleted.", {
                                        icon: "success",
                                        buttons: {
                                            confirm: {
                                                className: 'btn btn-success'
                                ...
                                error: function (error) {
                                    swal("Error!", "There was an issue deleting the customer.", "${error}");
                                }
                            });
                        }
                    });
