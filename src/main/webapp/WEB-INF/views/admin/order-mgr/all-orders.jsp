                                                            ...
                                                            <c:forEach var="status" items="${possibleStatuses}"
                                                                ...
                                                                <li class="nav-item">
                                                                    <a class="nav-link ${loop.first ? 'active' : ''}"
                                                                        ...
                                                                        ${status} <span
                                                                            class="badge bg-secondary">${ordersByStatus[status]
                                                                            != null ? ordersByStatus[status].size() :
                                                                            0}</span>
                                                                    </a>
                                                                </li>
                                                            </c:forEach>
                                                                ...
                                                                <div class="tab-pane fade ${loop.first ? 'show active' : ''}"
                                                                    ...
                                                                    <div class="table-responsive">
                                                                        <table
                                                                            ...
                                                                            <tbody>
                                                                                <c:forEach var="order"
                                                                                    items="${ordersByStatus[status]}"
                                                                                    varStatus="statusLoop">
                                                                                    <tr>
