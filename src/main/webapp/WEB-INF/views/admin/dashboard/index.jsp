<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link href="../../../../resources/assets2/css/css2?family=Nunito:wght@400;500;600;700;800&display=swap"
            rel="stylesheet">
        <link rel="stylesheet" type="text/css" media="screen"
            href="../../../../resources/assets2/css/perfect-scrollbar.min.css">
        <link rel="stylesheet" type="text/css" media="screen" href="../../../../resources/assets2/css/style.css">
        <link defer="" rel="stylesheet" type="text/css" media="screen"
            href="../../../../resources/assets2/css/animate.css">
        <script src="../../../../resources/assets2/js/perfect-scrollbar.min.js"></script>
        <script defer="" src="../../../../resources/assets2/js/popper.min.js"></script>
        <script defer="" src="../../../../resources/assets2/js/tippy-bundle.umd.min.js"></script>
        <script defer="" src="../../../../resources/assets2/js/sweetalert.min.js"></script>
    </head>
    ...
    <body x-data="main" class="relative overflow-x-hidden font-nunito text-sm font-normal antialiased"
                                ...
                                <div class="panel h-full pb-0 sm:col-span-2 xl:col-span-1">
                                    ...
                                    <div class="perfect-scrollbar relative -mr-3 mb-4 h-[290px] pr-3">
                                        <div class="cursor-pointer text-sm">
                                            ...
                                            <div class="group relative flex items-center py-1.5">
                                                <div class="h-1.5 w-1.5 rounded-full bg-danger ltr:mr-1 rtl:ml-1.5">
                                                </div>
                                            ...
                                            <div class="group relative flex items-center py-1.5">
                                                <div class="h-1.5 w-1.5 rounded-full bg-black ltr:mr-1 rtl:ml-1.5">
                                                </div>
                                        ...
                                        <div class="space-y-6">
                                            <div class="flex">
                                                ...
                                                <div class="flex-1 px-3">
                                                    <div>StarCode Kh</div>
                                                    <div class="text-xs text-white-dark dark:text-gray-500">10 Jan
                                                        1:00PM
                                                    </div>
                                                </div>
                                                <span
                                            ...
                                            <div class="flex">
                                                ...
                                                <div class="flex-1 px-3">
                                                    ...
                                                    <div class="text-xs text-white-dark dark:text-gray-500">04 Jan
                                                        1:00PM
                                                    </div>
                                                </div>
                                                <span
                                ...
                                <div class="panel h-full overflow-hidden border-0 p-0">
                                        ...
                                        <div class="mb-6 flex items-center justify-between">
                                            <div
                                                ...
                                                <img class="block h-8 w-8 rounded-full border-2 border-white/50 object-cover ltr:mr-1 rtl:ml-1"
                                                    src="../../../../resources/assets2/images/profile-34.jpeg"
                                                    alt="image">
                                                StarCode Kh
                                            </div>
                                            <button type="button"
                                    ...
                                    <div class="-mt-12 grid grid-cols-2 gap-2 px-8">
                                        <div class="rounded-md bg-white px-4 py-2.5 shadow dark:bg-[#060818]">
                                            <span
                                                class="mb-4 flex items-center justify-between dark:text-white">Received
                                        ...
                                        <div class="mb-5 space-y-1">
                                            <div class="flex items-center justify-between">
                                                ...
                                                <p class="text-base"><span>$</span> <span
                                                        class="font-semibold">13.85</span>
                                                </p>
                                            </div>
                                            <div class="flex items-center justify-between">
                                                <p class="font-semibold text-[#515365]">BlueHost VPN</p>
                                                <p class="text-base"><span>$</span> <span
                                                        class="font-semibold">15.66</span>
                                                </p>
                                            </div>
                                        </div>
                                            ...
                                            <tbody>
                                                    ...
                                                    <td class="min-w-[150px] text-black dark:text-white">
                                                        <div class="flex items-center">
                                                            <img class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                                src="../../../../resources/assets2/images/profile-6.jpeg"
                                                                alt="avatar">
                                                ...
                                                <tr
                                                    ...
                                                    <td class="text-black dark:text-white">
                                                        <div class="flex items-center">
                                                            <img class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                                src="../../../../resources/assets2/images/profile-7.jpeg"
                                                                alt="avatar">
                                                ...
                                                <tr
                                                    ...
                                                    <td class="text-black dark:text-white">
                                                        <div class="flex items-center">
                                                            <img class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                                src="../../../../resources/assets2/images/profile-8.jpeg"
                                                                alt="avatar">
                                                ...
                                                <tr
                                                    ...
                                                    <td class="text-black dark:text-white">
                                                        <div class="flex items-center">
                                                            <img class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                                src="../../../../resources/assets2/images/profile-9.jpeg"
                                                                alt="avatar">
                                                ...
                                                <tr
                                                    ...
                                                    <td class="text-black dark:text-white">
                                                        <div class="flex items-center">
                                                            <img class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                                src="../../../../resources/assets2/images/profile-10.jpeg"
                                                                alt="avatar">
                                            ...
                                            <tbody>
                                                <tr
                                                    ...
                                                    <td class="min-w-[150px] text-black dark:text-white">
                                                        <div class="flex">
                                                            <img class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                                src="../../../../resources/assets2/images/product-headphones.jpg"
                                                                alt="avatar">
                                                            <p class="whitespace-nowrap">Headphone <span
                                                                    class="block text-xs text-primary">Digital</span>
                                                            </p>
                                                        </div>
                                                    </td>
                                                    <td>$168.09</td>
                                                ...
                                                <tr
                                                    ...
                                                    <td class="text-black dark:text-white">
                                                        <div class="flex">
                                                            <img class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                                src="../../../../resources/assets2/images/product-shoes.jpg"
                                                                alt="avatar">
                                                            <p class="whitespace-nowrap">Shoes <span
                                                                    class="block text-xs text-warning">Faishon</span>
                                                            </p>
                                                        </div>
                                                    </td>
                                                    <td>$126.04</td>
                                                ...
                                                <tr
                                                    ...
                                                    <td class="text-black dark:text-white">
                                                        <div class="flex">
                                                            <img class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                                src="../../../../resources/assets2/images/product-watch.jpg"
                                                                alt="avatar">
                                                ...
                                                <tr
                                                    ...
                                                    <td class="text-black dark:text-white">
                                                        <div class="flex">
                                                            <img class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                                src="../../../../resources/assets2/images/product-laptop.jpg"
                                                                alt="avatar">
                                                ...
                                                <tr
                                                    ...
                                                    <td class="text-black dark:text-white">
                                                        <div class="flex">
                                                            <img class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                                src="../../../../resources/assets2/images/product-camera.jpg"
                                                                alt="avatar">
        ...
        <script defer="" src="../../../../resources/assets2/js/alpine-ui.min.js"></script>
        <script defer="" src="../../../../resources/assets2/js/alpine-focus.min.js"></script>
        <script defer="" src="../../../../resources/assets2/js/alpine.min.js"></script>
        <script src="../../../../resources/assets2/js/custom.js"></script>
        <script defer="" src="../../../../resources/assets2/js/apexcharts.js"></script>
