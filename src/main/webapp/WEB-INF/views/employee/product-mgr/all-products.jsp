                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <a href="${ctx}/employee/product-mgr/create"
                                                        ...
                                                        <tbody>
                                                            <c:forEach var="product" items="${products}"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="${ctx}/employee/product-mgr/detail/${product.productId}"
                                                                    ...
                                                                    <td>
                                                                        <div class="btn-group">
                                                                            ...
                                                                            <a href="${ctx}/employee/product-mgr/update/${product.productId}"
                                                                            ...
                                                                            <%-- Form for delete action --%>
                                                                                <form
                                                                                    ...
                                                                                    action="${ctx}/employee/product-mgr/delete/${product.productId}"
                                                                                    method="POST"
