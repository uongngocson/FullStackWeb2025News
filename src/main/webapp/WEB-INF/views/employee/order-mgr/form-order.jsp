                            ...
                            <div class="container">
                                <div class="page-inner">
                                    <div class="page-header">
                                        <h3 class="fw-bold mb-3">Edit Order #${order.orderId != null ? order.orderId :
                                            'Unknown'}</h3>
                                        ...
                                        <div class="col-md-12">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <c:if test="${order.orderId != null}">
                                                        <form action="/employee/order-mgr/save" method="post">
                                                            <sec:csrfInput />
                                                            <input type="hidden" name="orderId"
                                                                value="${order.orderId != null ? order.orderId : ''}" />
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            value="${order.orderId != null ? order.orderId : 'Unknown'}"
                                                                            readonly />
                                                                    </div>
                                                                    <div class="form-group">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            value="${order.totalAmount != null ? '$'.concat(order.totalAmount) : 'Unknown'}"
                                                                            readonly />
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label>Shipping Address</label>
                                                                        <input type="text" class="form-control"
                                                                            value="${order.shippingAddress != null ? order.shippingAddress.fullAddress : 'Unknown'}"
                                                                            readonly />
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label>Payment Method</label>
                                                                        <input type="text" class="form-control"
                                                                            value="${order.payment != null && order.payment.paymentMethod != null ? order.payment.paymentMethod : 'Unknown'}"
                                                                            readonly />
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            value="${order.customer != null && order.customer.firstName != null && order.customer.lastName != null ? order.customer.firstName.concat(' ').concat(order.customer.lastName) : 'Unknown'}"
                                                                            readonly />
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label>Email</label>
                                                                        <input type="text" class="form-control"
                                                                            value="${order.customer != null && order.customer.email != null ? order.customer.email : 'Unknown'}"
                                                                            readonly />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <c:if test="${empty possibleStatuses}">
                                                                            <p class="text-danger">No order statuses
                                                                                available.</p>
                                                                        </c:if>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <c:if test="${empty paymentStatuses}">
                                                                            <p class="text-danger">No payment statuses
                                                                                available.</p>
                                                                        </c:if>
                                                                    </div>
                                                                </div>
